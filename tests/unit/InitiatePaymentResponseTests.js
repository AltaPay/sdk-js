...
var InitiatePaymentResponseTests = {
	...
	getPaymentInfo_fromRealXml : function()
	{
		...
		Assert.equals('eCommerce', response.getPayment(0).getPaymentSource());
		Assert.equals('Visa', response.getPayment(0).getPaymentSchemeName());
	},
    ...
    getPaymentSource_exists : function()
    {
        var response = new InitiatePaymentResponse({Body:{Transactions:{Transaction:{PaymentSource:'eCommerce'}}}});

        Assert.equals('eCommerce',response.getPayment(0).getPaymentSource());
    },
    getPaymentSource_DoesNotExists : function()
    {
        var response = new InitiatePaymentResponse({Body:{Transactions:{Transaction:{}}}});

        Assert.equals(null,response.getPayment(0).getPaymentSource());
    }
}