...
MerchantApi.prototype.createPaymentRequest = function(request) {
	...
	return responseFactory.getPaymentRequestResponse(resultObject)
};
...
MerchantApi.prototype.refund = function(request)
{
	...
	return responseFactory.getRefundResponse(resultObject);
}
...
MerchantApi.prototype.release = function(request)
{
	...
	return responseFactory.getReleaseResponse(resultObject);
}
