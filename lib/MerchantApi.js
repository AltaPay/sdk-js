...
MerchantApi.prototype.login = function() {
	var xmlStr = this.http.post(this.url+'/merchant/API/login', {}, this.getHeaders());
...
/**
 * @param request {CheckoutSessionRequest}
 * @return {CheckoutSessionResponse}
 */
MerchantApi.prototype.checkoutSession = function (request) {
	var result = this.http.post(this.url + '/merchant/API/checkoutSession', request.toHash(), this.getHeaders());
	var responseObject = this.xml.deserialize(result);
	return this.responseFactory.getCheckoutSessionResponse(responseObject);
};
/**
...
{
	var result = this.http.get(this.url+'/merchant/API/fundingList',request.toHash(), this.getHeaders());
	var responseObject = this.xml.deserialize(result);
