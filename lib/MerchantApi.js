...
{
	var result = this.http.post(this.url+'/merchant/API/fundingList',request.toHash(), this.getAuthorizationHeader());
	var responseObject = this.xml.deserialize(result);
...
{
	return this.http.post(link,{}, this.getAuthorizationHeader());
}
