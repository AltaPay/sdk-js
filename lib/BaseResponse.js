 ...
 * @returns {string}
 */
BaseResponse.prototype.getCardHolderErrorMessage = function()
{
	return this.responseObject.Body.CardHolderErrorMessage;
};

/**
 * @returns {string}
 */
BaseResponse.prototype.getCardHolderMessageMustBeShown = function()
{
	return this.responseObject.Body.CardHolderMessageMustBeShown;
};

/**
 * @returns {string}
 */
BaseResponse.prototype.getReasonCode = function()
{
	return this.getPayment(0).getReasonCode();
};
