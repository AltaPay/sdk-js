...
var reservationId = createCapturedReservation("simple_partial_refund_");
...
if(response.success()==true){
    console.log("SimplePartialRefundExample: success");
}
else {
    console.log("SimplePartialRefundExample: failed : "+response.getErrorMessage());
}
