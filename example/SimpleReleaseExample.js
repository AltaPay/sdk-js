...
var reservationId = createReservation("simple_release_");
var request = factory.getReleaseRequest();
request.paymentId = reservationId;
var response = mapi.release(request);
if(response.success()==true){
    console.log("SimpleReleaseExample: success");
}
else {
    console.log("SimpleReleaseExample: failed : "+response.getErrorMessage());
}
