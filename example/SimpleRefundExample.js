...
var reservationId = createCapturedReservation("simple_refund_");
...
if(response.success()==true){
    console.log("SimpleRefundExample: success");
}
else {
    console.log("SimpleRefundExample: failed : "+response.getErrorMessage());
}
